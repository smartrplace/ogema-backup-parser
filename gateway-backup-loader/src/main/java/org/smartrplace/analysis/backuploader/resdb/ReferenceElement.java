 ...
 * @author jlapp
 */
public class ReferenceElement extends TransientTreeElement {

	private volatile TreeElement delegate;
	private final boolean decorating;

	public ReferenceElement(TreeElement reference, String name, TreeElement parent, boolean decorating, TransientResourceDB db) {
		super(name, reference.getType(), parent, decorating, db);
		this.delegate = reference;
		this.decorating = decorating;
		//System.out.printf("new reference: %s/%s -> %s%n", parent, name, reference);
	}
